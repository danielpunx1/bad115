 ...
 * @author daniel
 */
public class prerrequisito_insertar extends javax.swing.JFrame {

    /**
     * Creates new form prerrequisito_insertar
     */
    public prerrequisito_insertar() {
        initComponents();
        ...
        try{
            ...
            while (rs.next()){
                ...
                requisito.addItem( new combos_procedimientos( 1 ,rs.getString("codigo_asignatura") ));
            }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Ingresar prerrequisitos de materias"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(prerrequisito_insertar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
